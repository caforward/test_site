...
// Рубильник для СБП. Был выключен, пока платежи разворачивались: причина
// оказалась в неофициальном домене securepay.tbank.ru, на официальном
// securepay.tinkoff.ru развороты прекратились.
