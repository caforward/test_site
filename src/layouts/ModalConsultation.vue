	...
	<transition name="fade">
		<Modal id="requisites" v-if="visible">
			<div class="modal-content">
				...
				<p>
					Мы гарантируем, что никто не останется без внимания! Наши специалисты получают все заявки на
					обратную связь и
					отвечают на них так быстро, насколько это возможно.
					Просто введите свои контактные данные и ФИО, кратко опишите проблему и ожидайте, когда сотрудник ООО
					ПКО
