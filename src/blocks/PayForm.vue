...
// СБП какое-то время был отключён: платежи у клиентов уходили и тут же
// возвращались. Причина оказалась в неофициальном домене securepay.tbank.ru,
// после перехода на securepay.tinkoff.ru развороты прекратились.
// Флаг оставлен рубильником на случай, если способ снова придётся закрыть.
