<template>
    ...
    <vue-easy-lightbox :visible="visibleRef" :imgs="imgsRef" :index="indexRef" @hide="onHide" class="lightbox">
        <template v-slot:toolbar="{ toolbarMethods }">
            <a href="src/assets/images/AboutCompany/svo.pdf" target="_blank" class="lightbox-button button button_blue">Загрузить</a>
        </template>
    </vue-easy-lightbox>
</template>
...
const imgsRef = [
    {
        src: 'src/assets/images/AboutCompany/svo.jpg',
        title:
