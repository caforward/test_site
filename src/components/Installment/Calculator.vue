    ...
    <section id="calculate" class="section">
        <div class="custom-container">
            <div class="flex flex-col lg:flex-row gap-5 -mx-4 sm:m-0">
                <div class="bg-white w-full p-6 lg:w-6/12 sm:p-9 rounded-3xl shadow-[0_20px_30px_#0037911a]">
                    <BaseForm :showTitle="true" :inputs="inputs" />
                </div>
                <div class="bg-slate-300 w-full flex-1 p-6 sm:p-9 rounded-3xl shadow-[0_20px_30px_#0037911a] relative overflow-hidden">
                    <div class="flex gap-4 lg:flex-col">
                        <div class="flex gap-2 sm:gap-4 flex-col h-full">
                            ...
                            <p class="text-base">
                                Воспользуйтесь формой слева, чтобы рассчитать удобный для вас график платежей. Сделать это
                                легко: просто выберите сумму вашего долга, настройте срок погашения – и вы увидите, каким
                        ...
                        <div class="mt-auto hidden lg:block lg:h-2/5 lg:w-full xl:h-1/2 lg:absolute bottom-0 left-0">
                            <img src="/images/offers/calc.png" alt="Рассрочка" class="object-cover object-bottom h-full">
                        </div>
                    </div>
                </div>
            </div>
