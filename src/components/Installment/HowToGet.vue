    ...
    <section class="section">
        <div class="container">
            ...
            <p>
                ...
                компанией «Форвард» и сообщить о том, что Вы
                готовы работать над сложившейся ситуацией вместе с нами.
                <br><br>
                Затем нужно выяснить, какие варианты уменьшения долга
            ...
            <div class="under-content-wrap">
                <p class="under-content">
                    Узнав, какой способ уменьшения задолженности Вам доступен,
                    нужно достигнуть согласия с компанией «Форвард». В его
